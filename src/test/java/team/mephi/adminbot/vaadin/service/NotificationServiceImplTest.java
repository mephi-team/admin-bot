...
class NotificationServiceImplTest {
    ...
    void Given_newType_When_showNotification_Then_appliesSuccessVariant() {
        ...
        try (MockedStatic<I18NProvider> i18n = Mockito.mockStatic(I18NProvider.class);
            ...
            notificationStatic.when(() -> Notification.show(eq("translated"), eq(3000), eq(Notification.Position.TOP_END)))
            ...
            // Assert
            verify(notification).addThemeVariants(eq(NotificationVariant.LUMO_SUCCESS));
        }
    }
    ...
    void Given_editType_When_showNotification_Then_appliesWarningVariant() {
        ...
        try (MockedStatic<I18NProvider> i18n = Mockito.mockStatic(I18NProvider.class);
            ...
            // Assert
            verify(notification).addThemeVariants(eq(NotificationVariant.LUMO_WARNING));
        }
    }
    ...
    void Given_deleteType_When_showNotification_Then_appliesContrastVariant() {
        ...
        try (MockedStatic<I18NProvider> i18n = Mockito.mockStatic(I18NProvider.class);
            ...
            // Assert
            verify(notification).addThemeVariants(eq(NotificationVariant.LUMO_CONTRAST));
        }
    }
}
