...
public class StudentView extends VerticalLayout {
    ...
    public StudentView(StudentPresenter actions) {
        ...
        grid.addColumn(u -> Objects.nonNull(u.getDirection()) ? u.getDirection().stream().map(SimpleDirection::getName).collect(Collectors.joining(",")) : "").setHeader(getTranslation("grid_student_header_direction_label")).setSortable(true).setResizable(true).setKey("direction");
