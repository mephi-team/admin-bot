...
public class CandidateView extends VerticalLayout {
    ...
    public CandidateView(UsersPresenter actions) {
        ...
        grid.addColumn(MyRenderers.createUserDirections()).setHeader(getTranslation("grid_candidate_header_direction_label")).setSortable(true).setResizable(true).setKey("direction");
