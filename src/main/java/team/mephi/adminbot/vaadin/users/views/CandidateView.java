...
public class CandidateView extends VerticalLayout {
    ...
    public CandidateView(CandidateDataProvider provider, UserActions actions) {
        ...
        grid.addColumn(UserDto::getFullName).setHeader(getTranslation("grid_candidate_header_name_label")).setSortable(true).setKey("name");
        grid.addColumn(UserDto::getEmail).setHeader(getTranslation("grid_candidate_header_email_label")).setSortable(true).setKey("email");
        grid.addColumn(UserDto::getTgName).setHeader(getTranslation("grid_candidate_header_telegram_label")).setSortable(true).setKey("telegram");
        grid.addColumn(UserDto::getPhoneNumber).setHeader(getTranslation("grid_candidate_header_phone_label")).setSortable(true).setKey("phone");
        grid.addColumn(UserDto::getPdConsent).setHeader(getTranslation("grid_candidate_header_pd_consent_label")).setSortable(true).setKey("pd_consent");
