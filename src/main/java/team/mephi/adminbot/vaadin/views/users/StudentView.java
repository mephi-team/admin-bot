...
public class StudentView extends VerticalLayout {
    ...
    public StudentView(UserRepository userRepository, String role) {
        this.role = role;
        ...
        grid.addColumn(UserDto::getCity).setHeader("Куратор").setSortable(true);
        ...
        grid.addComponentColumn(item -> {
            ...
            return group;
        }).setHeader("Действия").setWidth("340px").setFlexGrow(0);
