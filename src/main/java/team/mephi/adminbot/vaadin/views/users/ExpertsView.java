...
public class ExpertsView extends VerticalLayout implements ProviderGet {
    ...
    public ExpertsView(UserRepository userRepository, String role, BiConsumer<Persistable<Long>, ProviderGet> onEdit, BiConsumer<Persistable<Long>, ProviderGet> onDelete) {
        this.role = role;
