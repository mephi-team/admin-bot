...
public class FreeListenerView extends VerticalLayout implements ProviderGet {
    ...
    public FreeListenerView(UserRepository userRepository, RoleRepository roleRepository, String role, BiConsumer<Long, ProviderGet> onView, BiConsumer<Long, ProviderGet> onEdit, BiConsumer<List<Long>, ProviderGet> onDelete) {
        this.role = role;
