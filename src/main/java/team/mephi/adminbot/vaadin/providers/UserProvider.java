    ...
    public UserProvider(UserRepository questionRepository, String role, TextField searchField) {
        super(query -> {
                    ...
                    return questionRepository.findAllByRoleAndName(role, searchField.getValue())
                            .stream()
                            .map(u -> new UserDto(u.getId(), u.getUserName(), u.getLastName() + " " + u.getFirstName(), u.getEmail(), u.getTgName(), u.getPhoneNumber(), u.getPdConsent(), u.getCohort(), u.getDirection() != null ? u.getDirection().getName() : "", u.getCity(), u.getStatus() != null ? u.getStatus().name() : "", u.getDeleted()))
