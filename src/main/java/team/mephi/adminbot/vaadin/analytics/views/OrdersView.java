...
public class OrdersView extends VerticalLayout {
    ...
    public OrdersView(ChartPresenter<OrderFilterData> presenter) {
        setPadding(false);

        OrderFrom form = new OrderFrom();
        binder.forField(form.getCohort()).bind(OrderFilterData::getCohort, OrderFilterData::setCohort);
