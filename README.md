...
Позволяет администраторам и экспертам работать с пользователями, диалогами, вопросами, рассылками, зачислением и
аналитикой.

[Ссылка на описание](https://docs.google.com/document/d/1hhpqmjXqQNh6uYxkwdkhO4AOg3xN3HpbeyVTU7sjXLY/edit?usp=sharing)
...
- **Пользователи**: просмотр, фильтрация, изменение ролей (`visitor`, `candidate`, `student` и др.), массовое добавление
  через Excel.
...
- **Зачисление**:
    ...
    - **Скрипт регистрации**: массовая загрузка пользователей из Excel с автоматической регистрацией в Keycloak и
      NeoStudy.
